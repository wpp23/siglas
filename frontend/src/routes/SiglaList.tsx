...
export default function SiglaList() {
  ...
  const colunas = [
    { titulo: 'ID', campo: 'idsistema', tamanho: 'col-1', pesquisa: false  },
    { titulo: 'Sigla', campo: 'siglasistema', tamanho: 'col-1', pesquisa: true  },   
    { titulo: 'Descrição', campo: 'descricaosistema', tamanho: 'col-6', pesquisa: true  },   
    { titulo: 'Sistema Pai', campo: 'sisrelacionado', tamanho: 'col-1', pesquisa: false  },
    { titulo: 'Tipo', campo: 'descrtiposistema', tamanho: 'col-2', pesquisa: true  }, 
    { titulo: 'Área Gestora', campo: 'siglaarea', tamanho: 'col-1', pesquisa: true  },   
    { titulo: 'Situação', campo: 'descrsituacaosistema', tamanho: 'col-1', pesquisa: true  }
  ]
